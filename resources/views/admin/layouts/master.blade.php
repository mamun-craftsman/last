		...
		<div class="flex items-start">
		  <nav id="sidebar" class="lg:min-w-[250px] w-max max-lg:min-w-8">
			<div id="sidebar-collapse-menu"
			  ...
			  <div class="flex items-center justify-center gap-2 pt-6 pb-2 px-4 sticky top-0 bg-white min-h-[30px] z-[100]">
				<a href="javascript:void(0)"><img src="{{asset('/home/images/logo.jpg')}}" alt="logo"
					class='w-[80px]' />
				</a>
				...
				<ul class="space-y-2">
				  ...
				  <li>
					<a href="javascript:void(0)"
					  ...
					  <span class="overflow-hidden text-ellipsis whitespace-nowrap">Blogs</span>
					  <svg xmlns="http://www.w3.org/2000/svg"
						class="arrowIcon w-3 fill-current -rotate-90 ml-auto transition-all duration-500"
						viewBox="0 0 451.847 451.847">
						<path
				  ...
				  <li>
					...
					<ul class="sub menu max-h-0 overflow-hidden transition-[max-height] duration-500 ease-in-out ml-8">
					  <li>
						<a href="{{route('admin.show_categories')}}"
						  class="text-gray-800 text-sm block cursor-pointer hover:bg-gray-100 rounded-md px-3 py-2 transition-all duration-300">
				  ...
				  <li>
					<a href="javascript:void(0)"
					  ...
					  <span class="overflow-hidden text-ellipsis whitespace-nowrap">Store Location</span>
					  <svg xmlns="http://www.w3.org/2000/svg"
						class="arrowIcon w-3 fill-current -rotate-90 ml-auto transition-all duration-500"
						viewBox="0 0 451.847 451.847">
						<path
		  ...
		  <section class="main-content w-full px-2 sm:px-4 md:px-6">
...
<!-- Toastr JS (add before the closing </body>) -->
